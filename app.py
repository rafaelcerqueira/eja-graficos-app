...
if modalidade == "Matrículas por sexo" and ano == 2013 and localidade == "Bahia":
    ...
    #----------------------------------------------------------------------------------
    # lê os dados de matrículas de Salvador
...
if modalidade == "Matrículas por sexo" and ano == 2014 and localidade == "Bahia":
    
    #----------------------------------------------------------------------------------
    # lê os dados de matrículas da Bahia
    dados_total_matriculas = leitor.ler_dados_sexo_bahia('dados_2014', 'dados_total_matriculas_por_sexo_2014.json')
    dados_percentual_total = leitor.ler_dados_sexo_bahia('dados_2014', 'json_dados_percentual_total_por_sexo_2014.json')
    dados_percentual_dependencia_administrativa = leitor.ler_dados_sexo_bahia('dados_2014', 'dados_percentual_por_sexo_dependencia_administrativa_2014.json')
    dados_total_matriculas_dep_adm = leitor.ler_dados_sexo_bahia('dados_2014', 'dados_matriculas_por_sexo_por_dependencia_administrativa_2014.json')
    ...
    # exibe o percentual total por sexo
    fig = px.bar(df_percentual_total, x='sexo', y='total', color='sexo', text='total', title='Percentual total de matrículas por sexo na Bahia em 2014')
    fig.update_layout(height=600, width=900)
    
    # exibe o percentual por dependência administrativa 2014
    fig2 = px.bar(
        df_percentual_dependencia_administrativa,
        y=['Estadual', 'Federal', 'Municipal', 'Privada'],
        x=['Feminino', 'Masculino', 'Feminino', 'Masculino'],
        barmode='stack',
        labels={'y': 'Dependência administrativa', 'x': 'Sexo', 'value': 'Percentual', 'color': 'Sexo'},
        title='Percentual por dependência administrativa na Bahia em 2014'
    )
    ...
    # exibe o total de matrículas por dependência administrativa 2014
    fig3 = px.bar(
        df_total_matriculas_dep_adm,
        y=['Estadual', 'Municipal', 'Privada', 'Federal'],
        x=['Feminino', 'Masculino', 'Feminino', 'Masculino'],
        labels={'x': 'Sexo', 'y': 'Dependência administrativa', 'value': 'Total de matrículas', 'color': 'Sexo'},
        barmode='stack',
        title='Total de matrículas por sexo e dependência administrativa na Bahia em 2014'
        )
    ...
    # exibe o total de matrículas por sexo
    fig4 = px.bar(df_total_matriculas, x='sexo', y='total', color='sexo', text='total', title='Total de matrículas por sexo na Bahia em 2014')
    ...
    #---------------------------------------------------------------------------------
    # renderiza o gráfico
    st.subheader("Percentual total por sexo na Bahia em 2014")
    st.plotly_chart(fig)
    st.subheader("Percentual por dependência administrativa na Bahia em 2014")
    st.plotly_chart(fig2)
    st.subheader("Total de matrículas por dependência administrativa na Bahia em 2014")
    st.plotly_chart(fig3)
    st.subheader("Total de matrículas por sexo na Bahia em 2014")
    st.plotly_chart(fig4)
    
    
elif modalidade == "Matrículas por sexo" and ano == 2014 and localidade == "Salvador":
    #----------------------------------------------------------------------------------
    # lê os dados de matrículas de Salvador
    dados_percentual_total = leitor.ler_dados_sexo_salvador('dados_2014', 'json_dados_percentual_total_por_sexo_2014.json')
    dados_percentual_dependencia_administrativa = leitor.ler_dados_sexo_salvador('dados_2014', 'dados_percentual_por_sexo_dependencia_administrativa_2014.json')
    dados_total_matriculas_dep_adm = leitor.ler_dados_sexo_salvador('dados_2014', 'dados_matriculas_por_sexo_por_dependencia_administrativa_2014.json')
    dados_total_matriculas = leitor.ler_dados_sexo_salvador('dados_2014', 'dados_total_matriculas_por_sexo_2014.json')
    ...
    #---------------------------------------------------------------------------------
    # exibe o percentual total por sexo
    fig = px.bar(df_percentual_total, x='sexo', y='total', color='sexo', text='total', title='Percentual total de matrículas por sexo em Salvador em 2014')
    fig.update_layout(height=600, width=900)
    ...
    fig2 = px.bar(
        ...
        barmode='stack',
        labels={'y': 'Dependência administrativa', 'x': 'Sexo', 'value': 'Percentual', 'color': 'Sexo'},
        title='Percentual por dependência administrativa em Salvador em 2014'
    )
    ...
    fig3 = px.bar(
        ...
        labels={'x': 'Sexo', 'y': 'Dependência administrativa', 'value': 'Total de matrículas', 'color': 'Sexo'},
        barmode='stack',
        title='Total de matrículas por sexo e dependência administrativa em Salvador em 2014'
        )
    ...
    fig4 = px.bar(df_total_matriculas, x='sexo', y='total', color='sexo', text='total', title='Total de matrículas por sexo em Salvador em 2014')
    ...
    #---------------------------------------------------------------------------------
    # renderiza o gráfico
    st.subheader("Percentual total por sexo em Salvador em 2014")
    st.plotly_chart(fig)
    st.subheader("Percentual por dependência administrativa em Salvador em 2014")
    st.plotly_chart(fig2)
    st.subheader("Total de matrículas por dependência administrativa em Salvador em 2014")
    st.plotly_chart(fig3)
    st.subheader("Total de matrículas por sexo em Salvador em 2014")
    st.plotly_chart(fig4)
...
# 2022:
if modalidade == "Matrículas por sexo" and ano == 2022 and localidade == "Bahia":
    
    #----------------------------------------------------------------------------------
    # lê os dados de matrículas da Bahia
    dados_total_matriculas = leitor.ler_dados_sexo_bahia('dados_2022', 'dados_total_matriculas_por_sexo_2022.json')
    dados_percentual_total = leitor.ler_dados_sexo_bahia('dados_2022', 'dados_percentual_total_por_sexo_2022.json')
    dados_percentual_dependencia_administrativa = leitor.ler_dados_sexo_bahia('dados_2022', 'dados_percentual_por_sexo_dependencia_administrativa_2022.json')
    dados_total_matriculas_dep_adm = leitor.ler_dados_sexo_bahia('dados_2022', 'dados_matriculas_por_sexo_por_dependencia_administrativa_2022.json')
    ...
    #---------------------------------------------------------------------------------
    # cria os gráficos
    fig = px.bar(df_percentual_total, x='sexo', y='total', color='sexo', text='total', title='Percentual total de matrículas por sexo na Bahia em 2022')
    fig.update_layout(height=600, width=900)
    ...
    fig2 = px.bar(
        ...
        barmode='stack',
        labels={'y': 'Dependência administrativa', 'x': 'Sexo', 'value': 'Percentual', 'color': 'Sexo'},
        title='Percentual por dependência administrativa na Bahia em 2022'
    )
    ...
    fig3 = px.bar(
        ...
        labels={'x': 'Sexo', 'y': 'Dependência administrativa', 'value': 'Total de matrículas', 'color': 'Sexo'},
        barmode='stack',
        title='Total de matrículas por sexo e dependência administrativa na Bahia em 2022'
    )
    
    fig3.update_traces(texttemplate='%{value:.3s}', textposition='outside')
    fig3.update_layout(height=600, width=900)
    
    fig4 = px.bar(df_total_matriculas, x='sexo', y='total', color='sexo', text='total', title='Total de matrículas por sexo na Bahia em 2022')
    ...
    #---------------------------------------------------------------------------------
    # renderiza o gráfico
    st.subheader("Percentual total por sexo na Bahia em 2022")
    st.plotly_chart(fig)
    st.subheader("Percentual por dependência administrativa na Bahia em 2022")
    st.plotly_chart(fig2)
    st.subheader("Total de matrículas por dependência administrativa na Bahia em 2022")
    st.plotly_chart(fig3)
    st.subheader("Total de matrículas por sexo na Bahia em 2022")
    st.plotly_chart(fig4)
    
    
elif modalidade == "Matrículas por sexo" and ano == 2022 and localidade == "Salvador":
    #----------------------------------------------------------------------------------
    # lê os dados de matrículas de Salvador
    dados_total_matriculas = leitor.ler_dados_sexo_salvador('dados_2022', 'dados_total_matriculas_por_sexo_2022.json')
    dados_percentual_total = leitor.ler_dados_sexo_salvador('dados_2022', 'json_dados_percentual_total_por_sexo_2022.json')
    dados_percentual_dependencia_administrativa = leitor.ler_dados_sexo_salvador('dados_2022', 'dados_percentual_por_sexo_dependencia_administrativa_2022.json')
    dados_total_matriculas_dep_adm = leitor.ler_dados_sexo_salvador('dados_2022', 'dados_matriculas_por_sexo_por_dependencia_administrativa_2022.json')
    ...
    #---------------------------------------------------------------------------------
    # exibe o percentual total por sexo
    fig = px.bar(df_percentual_total, x='sexo', y='total', color='sexo', text='total', title='Percentual total de matrículas por sexo em Salvador em 2022')
    fig.update_layout(height=600, width=900)
    ...
    fig2 = px.bar(
        ...
        barmode='stack',
        labels={'y': 'Dependência administrativa', 'x': 'Sexo', 'value': 'Percentual', 'color': 'Sexo'},
        title='Percentual por dependência administrativa em Salvador em 2022'
    )
    ...
    fig3 = px.bar(
        ...
        labels={'x': 'Sexo', 'y': 'Dependência administrativa', 'value': 'Total de matrículas', 'color': 'Sexo'},
        barmode='stack',
        title='Total de matrículas por sexo e dependência administrativa em Salvador em 2022'
        )
    ...
    fig4 = px.bar(df_total_matriculas, x='sexo', y='total', color='sexo', text='total', title='Total de matrículas por sexo em Salvador em 2022')
    ...
    #---------------------------------------------------------------------------------
    # renderiza o gráfico
    st.subheader("Percentual total por sexo em Salvador em 2022")
    st.plotly_chart(fig)
    st.subheader("Percentual por dependência administrativa em Salvador em 2022")
    st.plotly_chart(fig2)
    st.subheader("Total de matrículas por dependência administrativa em Salvador em 2022")
    st.plotly_chart(fig3)
    st.subheader("Total de matrículas por sexo em Salvador em 2022")
    st.plotly_chart(fig4)
